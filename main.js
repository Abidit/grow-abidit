...
const achievements = [
  {
    ...
    impact:
      "Adopted by 40+ institutions globally including US-based bootcamps, universities, and training programs.",
  },
  {
    statValue: "Co-owned",
    ...
    impact:
      'Shifted the platform\'s value proposition from "lesson consumer" to "project builder" — shipped to every user on Programiz PRO.',
  },
  {
    statValue: "<2mo",
    ...
    impact:
      "Enabled playable learning experiences for beginners and career switchers. Multiple follow-on visualizers built on the same foundation.",
  },
  {
    statValue: "GPT-4o",
  ...
  },
  {
    ...
    impact:
      "Established challenges as a new acquisition channel. Validated the engagement-to-monetization link with BigQuery.",
  },
  {
    statValue: "0",
    ...
    impact:
      "Converted 4 users (~1.36%) to annual plans with zero immediate cancellations. Validated willingness-to-pay signal for future pricing experiments.",
  },
  {
    statValue: "3 days",
    ...
    impact:
      "Used by US professors in university classrooms. Coin Change makes advanced concepts accessible to learners under 16.",
  },
  {
    statValue: "6K/mo",
    ...
    impact:
      "~6K organic visits/month, 56% US traffic. Traffic value ~$1.1K/month. Strengthened SEO presence for R-language learning.",
  },
];
...
const projects = [
  {
    name: "EduShip",
    desc: "Production-ready Next.js boilerplate for EdTech platforms. Clerk auth, Supabase, course/lesson system, MCQ quiz engine, certificate generation, and Lemon Squeezy payments — pre-wired and production-ready.",
    tech: [
      "Next.js 16",
      "TypeScript",
      "Tailwind CSS",
...
function renderStack() {
  ...
  if (!grid) return;
  grid.innerHTML = Object.entries(stack)
    .map(
      ([category, pills]) => `
...
function initScrollReveal() {
  ...
  document
    .querySelectorAll(
      ".timeline-block, .win-card, .stack-category, .project-card",
    )
    .forEach((el) => {
      observer.observe(el);
    });
